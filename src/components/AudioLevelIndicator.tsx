...
import { type AudioTrack, type LocalAudioTrack, type RemoteAudioTrack } from 'twilio-video'
...
function AudioLevelIndicator({ audioTrack, color = 'white' }: AudioLevelIndicatorProps) {
